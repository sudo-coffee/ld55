...
func _init():
    ...
    create_unit("pot", 0, Vector2i(3, 0))
    create_unit("pot", 1, Vector2i(5, 0))
    create_unit("pot", 2, Vector2i(0, 3))
    create_unit("pot", 3, Vector2i(8, 3))
    create_unit("pot", 4, Vector2i(0, 5))
    create_unit("pot", 5, Vector2i(8, 5))
    create_unit("pot", 6, Vector2i(3, 8))
    create_unit("pot", 7, Vector2i(5, 8))
    create_unit("spout", 0, Vector2i(4, 0))
    create_unit("spout", 1, Vector2i(0, 4))
    create_unit("spout", 2, Vector2i(8, 4))
    create_unit("spout", 3, Vector2i(4, 8))
    create_unit("vault", 0, Vector2i(0, 7))
    create_unit("vault", 1, Vector2i(1, 8))
    create_unit("vault", 2, Vector2i(7, 0))
    create_unit("vault", 3, Vector2i(8, 1))
    create_unit("orb", 0, Vector2i(0, 1))
    create_unit("orb", 1, Vector2i(1, 0))
    create_unit("clock", 0, Vector2i(7, 8))
    create_unit("clock", 1, Vector2i(8, 7))
    create_unit("stand", 0, Vector2i(6, 6))
    create_unit("altar", 0, Vector2i(2, 2))
